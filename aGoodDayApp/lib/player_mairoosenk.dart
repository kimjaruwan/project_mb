...
class Player_mairoosenk extends StatefulWidget {
  Player_mairoosenk({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_mairoosenk> with SingleTickerProviderStateMixin {
  //audio
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/mairoosenk-tilly.mp3'),
