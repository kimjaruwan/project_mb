...
class Player_kangkun extends StatefulWidget {
  Player_kangkun({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_kangkun>
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/kangkun-3.mp3'),
