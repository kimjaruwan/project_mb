...
class Albums_lovesongs extends StatefulWidget {
  Albums_lovesongs({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _Albums_lovesongsState createState() => _Albums_lovesongsState();
}

class _Albums_lovesongsState extends State<Albums_lovesongs> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text("Albums Love Songs", style: TextStyle(
                  color: Colors.black,
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Player_luxtherpaitookwan()));
                      },
                      child: artistSongs("assets/potatocover.jpg",
                          "รักเธอไปทุกวัน", "POTATO", "3:34"),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: artistSongs("assets/3mandowncover.jpg", "ข้างกัน",
                          "Three Man Down", "4:56"),
                    ),
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Player_yangmeechan()));
                      },
                      child: artistSongs("assets/potatocover.jpg", "ยังมีฉัน",
                          "POTATO", "5:17"),
                    ),
                  ],
                ),
