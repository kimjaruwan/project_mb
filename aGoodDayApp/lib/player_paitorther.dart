...
class Player_paitorther extends StatefulWidget {
  Player_paitorther({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_paitorther> with SingleTickerProviderStateMixin {
  //audio
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/paitorther-3.mp3'),
                   ...
                   GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Player_tatherluxchanjing()));
                      player.stop();
                    },
                    child: Icon(
                      Icons.arrow_left,
