...
class Player_pakdee extends StatefulWidget {
  Player_pakdee({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_pakdee>
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/pakdee-potato.mp3'),
