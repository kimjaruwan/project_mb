...
class Player_kittaemaitueng extends StatefulWidget {
  Player_kittaemaitueng({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_kittaemaitueng> with SingleTickerProviderStateMixin {
  //audio
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/kittaemaitueng-tilly.mp3'),
