...
class Player_yangmeechan extends StatefulWidget {
  Player_yangmeechan({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_yangmeechan>
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/yangmeechan-potato.mp3'),
