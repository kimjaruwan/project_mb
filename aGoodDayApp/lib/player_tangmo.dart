...
class Player_tangmo extends StatefulWidget {
  Player_tangmo({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_tangmo>
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/tangmo1.mp3'),
