...
class Player_tatherluxchanjing extends StatefulWidget {
  Player_tatherluxchanjing({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_tatherluxchanjing>
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('tatherluxchanjing-3.mp3'),
