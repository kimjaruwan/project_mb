...
class Player_taraojerkunaek extends StatefulWidget {
  Player_taraojerkunaek({Key? key, this.title}) : super(key: key);
...
class _PlayerState extends State<Player_taraojerkunaek> with SingleTickerProviderStateMixin {
  //audio
  ...
  void initState() {
    ...
    super.initState();
    player.open(Audio('assets/taraojerkunaek-tilly.mp3'),
